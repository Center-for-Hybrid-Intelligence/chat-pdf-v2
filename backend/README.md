# hiden prompts of the chain typess
## Stuff
...
```
## Refine
Can be found in the langchain github at langchain/chains/question_answering/refine_prompts.py
```
...
## Map Rerank
Can be found in the langchain github at langchain/chains/question_answering/map_rerank_prompt.py
